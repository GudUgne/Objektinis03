		...
		if (atsakymas == "Failas") {
			...
			for (int i = 0; i < 1; i++) {
				...
				if (atsakymas == "Naujas") {				//jei naujas failas
					...
					for (int i = 0; i < 2; i++) {		//kad darytu tik 100k ir 1,000,000

						DuomenuFailoGeneravimas(a, 5); //uzkomentuoti jei  jau yra ikelti failai, kad butu greiciau
						...
						cout << "veikia" << endl;
						sort(Stud.begin(), Stud.end());		// cia buvo naudotas operatorius
						cout << "dar veikia" << endl;
